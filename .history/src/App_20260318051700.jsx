...
// 1. Impor komponen dari react-pdf
import { Document, Page, pdfjs } from 'react-pdf';
import './App.css';

// 2. Konfigurasi Worker PDF.js (Wajib agar proses baca PDF tidak membuat browser lag)
...
function App() {
  ...
  // --- STATE BARU UNTUK CUSTOM VIEWER ---
  ...
  const handleFileUpload = (event) => {
    ...
    if (file && file.type === 'application/pdf') {
      ...
      setPageNumber(1); // Reset ke halaman 1 saat file baru diunggah
    } else {
