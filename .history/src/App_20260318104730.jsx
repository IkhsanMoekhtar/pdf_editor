...
function App() {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e) => {
      // PENTING: Jika toggle mati, fungsi berhenti dan browser akan scroll normal
    ...
    // Pasang sensor roda mouse
    container.addEventListener('wheel', handleWheel, { passive: false });
    
    // Bersihkan sensor saat komponen di-refresh
              ...
              >
                ...
                >
                  <Page 
                    ...
                    // A. Rekam ukuran asli PDF saat berhasil dimuat ke dalam memori
                    onLoadSuccess={onPageLoadSuccess}
                    
                    // B. Terapkan perhitungan skala cerdas kita di sini
